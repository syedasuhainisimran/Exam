...
<div class="input-group mb-3">
  ...
  <input type="file" class="form-control" name="image" id="inputGroupFile01" ></div>
</div>
<div class="mb-3">
  
  <input type="submit" class="form-control" value="submit" id="exampleFormControlInput1" placeholder="name@example.com">
